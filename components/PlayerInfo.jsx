		...
		<section className="c-player">
			...
			<header className="c-player__header">
				<div className="c-player__header-container">
					...
					<div className="c-player__header-info">
						...
						{(keeper || defence) && 
							<p>Clean sheets: <span className="c-player__header-values">{ clean_sheets }</span></p>
						}
						{keeper &&
							<p>Penalties saved: <span className="c-player__header-values">{ penalties_saved }</span></p>
						}
						{!keeper &&
							<Fragment>
			...
			<div className="c-player__body">
				<ul className="c-player__body-list">
					...
					<li>
						Chance of playing: <span>{ chance_of_playing_this_round || 'Fit' }</span>
					</li>
					<li>
